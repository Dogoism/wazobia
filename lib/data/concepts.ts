...
export const SEED_CONTRIBUTOR: ContributorRef = {
  displayName: "YARN editorial seed",
  kind: "seed",
};

export const AI_CONTRIBUTOR: ContributorRef = {
  displayName: "AI suggestion (unreviewed)",
  kind: "ai",
};
